<?php
  ...
  if(isset($_POST['entered'])){
    $nik = $_POST['nik'];
    $tipe = $_POST['kepindahan'];
  
    if($tipe == 'datang')
      $data = getVerifiedDatang($nik);
    else if($tipe == 'keluar')
      $data = getVerifiedKeluar($nik);
    else if($tipe == 'dalam')
      $data= getVerifiedDalam($nik);
  }
?>
      ...
      <div class="col">
          ...
          <div class="bg-light lter">    
              <ul class="breadcrumb bg-grey-breadcrumb m-b-none">
                ...
                <li><a href>Home</a></li>
                <li class="active"><i class="fa fa-angle-right"></i>Print</li>
              </ul>
          </div>

          <div class="bg-light lter b-b wrapper-md padder-md">
            <h1 class="m-n font-bold h4 padder">Tampilan Lembar Pengesahan Kepindahan</h1>
          </div> 
      <!-- App-content-body -->
    ...
    <div class="row">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form role="form" class="bs-example form-horizontal" method="post" action=#>
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label">Jenis Kepindahan</label>
                <div class="col-lg-10">
                  <select class="form-control" name="kepindahan">
                  <option value="dalam">Kepindahan Dalam Kota</option>
                  <option value="datang">Kepindahan Dari Luar Kota</option>
                  <option value="keluar">Kepindahan Keluar Kota</option>
                  </select>
                </div>
              </div>
              <input type="hidden" class="form-control" name="entered" value=1>
              <button class="btn m-b-sm m-r-sm btn-info" type="submit" >Submit</button>
            </form>
            <br><br>
          </div>
      </div>
    </div>
 <?php if(isset($_POST['entered']) &&  isset($data)) : ?>
    <div class="row">
        <div class="panel panel-default">
          <div class="panel-heading font-bold">Tampilan</div>
          <div class="panel-body">

            <form role="form" class="bs-example form-horizontal" action="print.php" method="post">

              <div class="form-group">
                <div class="col-lg-10">
                  <h3 align=center>Lembar Lembar Pengesahan Kepindahan</h3>
                  <br><br>
                  <h5>Dengan surat ini telah disahkan kepindahan penduduk dengan :</h5>
                  <h5>Nama:     <?php echo $_POST['nama'] ?></h5>
                  <h5>NIK :     <?php echo $data['nik'] ?></h5>
                  <br>
                  <h5>dari alamat asal:</h5>
                  <h5>Kota      :     <?php echo $data['asal_kota'] ?></h5>
                  <h5>Kecamatan :     <?php echo $data['asal_kecamatan'] ?></h5>
                  <h5>Kelurahan :     <?php echo $data['asal_kelurahan'] ?></h5>
                  <h5>RW        :     <?php echo $data['asal_rw'] ?></h5>
                  <h5>RT        :     <?php echo $data['asal_rt'] ?></h5>
                  <h5>Alamat    :     <?php echo $data['asal_alamat'] ?></h5>
                  <br>
                  <h5>ke alamat tujuan:</h5>
                  <h5>Kota      :     <?php echo $data['tujuan_kota'] ?></h5>
                  <h5>Kecamatan :     <?php echo $data['tujuan_kecamatan'] ?></h5>
                  <h5>Kelurahan :     <?php echo $data['tujuan_kelurahan'] ?></h5>
                  <h5>RW        :     <?php echo $data['tujuan_rw'] ?></h5>
                  <h5>RT        :     <?php echo $data['tujuan_rt'] ?></h5>
                  <h5>Alamat    :     <?php echo $data['tujuan_alamat'] ?></h5>
                  <br>
                  <h5 align=right>Mengetahui,</h5>
                  <br><br><br>
                  <h5 align=right>Petugas Disdukcapil</h5>
